...
$gev = 0;
$fd = fopen("opdr6/DATA/namen.txt","r");
while (!feof($fd) && $gev == 0) {
...
$gev2 = 0;
if ($gev == 1) {
	$fd2 = fopen("opdr6/DATA/adressen.txt","r");
...
$blocked = false;
$blockedips = file_get_contents("opdr6/DATA/blocked.txt");
...
$counter = file_get_contents("opdr6/DATA/counter.txt");
if (!$blocked) {
	$counter++;
	file_put_contents("opdr6/DATA/counter.txt", $counter);
}
